/** ASHIMA CODE - classicNoise3D.glsl - https://github.com/ashima/webgl-noise/blob/master/src/classicnoise3D.glsl */
//
...
float turbulence( vec3 p ) {
    ...
    for (float f = 1.0; f <= 10.0; f++) {
        ...
        // pnoise comes from the Ashima code pasted above, I believe it generates the noise
